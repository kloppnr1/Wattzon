    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-400 font-medium">{t('correctionDetail.loading')}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 sm:p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-4 flex items-center gap-2 text-sm text-slate-500">
        <Link to="/billing" className="hover:text-teal-600">{t('correctionDetail.breadcrumbBilling')}</Link>
        <span>/</span>
        <Link to="/billing/corrections" className="hover:text-teal-600">{t('correctionDetail.breadcrumbCorrections')}</Link>
        <span>/</span>
        <span className="text-slate-900 font-medium">{t('correctionDetail.breadcrumbDetail')}</span>
      </div>
