  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-4 flex items-center gap-2 text-sm text-slate-500">
        ...
        <span>/</span>
        <span className="text-slate-900 font-medium">Period {period.periodStart}</span>
      </div>

      {/* Page header */}
      <div className="mb-6 animate-fade-in-up">
        <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Billing Period</h1>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6 animate-fade-in-up" style={{ animationDelay: '60ms' }}>
        <h2 className="text-lg font-semibold text-slate-900 mb-4">Period Information</h2>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden animate-fade-in-up" style={{ animationDelay: '120ms' }}>
        <div className="px-6 py-4 border-b border-slate-200">
          <h2 className="text-lg font-semibold text-slate-900">Settlement Runs</h2>
          <p className="text-sm text-slate-500 mt-1">{period.settlementRuns.length} total runs</p>
        </div>
