...
{
    /// <summary>
    /// Estimates a quarterly aconto payment based on annual consumption and expected price per kWh.
    ...
    /// Default annual consumption: 4,000 kWh/year (typical Danish house).
    /// </summary>
    public static decimal EstimateQuarterlyAmount(
        decimal annualConsumptionKwh,
    ...
    {
        var quarterlyKwh = annualConsumptionKwh / 4m;
        ...
        return Math.Round(subtotal * (1 + vatRate), 2);
    }
