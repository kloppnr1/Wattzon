...
public interface ISpotPriceRepository
{
    ...
    Task<(IReadOnlyList<SpotPriceRow> Items, int TotalCount)> GetPricesPagedAsync(string priceArea, DateTime from, DateTime to, int page, int pageSize, CancellationToken ct);
