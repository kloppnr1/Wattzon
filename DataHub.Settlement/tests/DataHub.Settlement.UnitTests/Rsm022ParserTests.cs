...
public class Rsm022ParserTests
{
    ...
    [Fact]
    public void ParseRsm022_extracts_gsrn()
    {
        var result = _sut.ParseRsm022(LoadFixture());

        result.MeteringPointId.Should().Be("571313100000012345");
    }

    [Fact]
    public void ParseRsm022_extracts_grid_area_and_price_area()
    {
        var result = _sut.ParseRsm022(LoadFixture());
    ...
    [Fact]
    public void ParseRsm022_extracts_type_and_settlement_method()
    {
        var result = _sut.ParseRsm022(LoadFixture());
    ...
    [Fact]
    public void ParseRsm022_extracts_supply_start()
    {
        var result = _sut.ParseRsm022(LoadFixture());
    ...
    [Fact]
    public void ParseRsm022_extracts_message_id_and_grid_operator()
    {
        var result = _sut.ParseRsm022(LoadFixture());

        result.MessageId.Should().Be("msg-rsm022-001");
